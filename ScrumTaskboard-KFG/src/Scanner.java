		...
		loop: for (;;) {
			switch (state) {
				...
				case 28:
					{t.kind = 7; break loop;}
				case 29:
					if (ch == 'a') {AddCh(); state = 30; break;}
					else {state = 0; break;}
				case 30:
					if (ch == 's') {AddCh(); state = 31; break;}
					else {state = 0; break;}
				case 31:
					if (ch == 'k') {AddCh(); state = 32; break;}
					else {state = 0; break;}
				case 32:
					if (ch == 'b') {AddCh(); state = 33; break;}
					else {state = 0; break;}
				case 33:
					if (ch == 'o') {AddCh(); state = 34; break;}
					else {state = 0; break;}
				case 34:
					if (ch == 'a') {AddCh(); state = 35; break;}
					else {state = 0; break;}
				case 35:
					if (ch == 'r') {AddCh(); state = 36; break;}
					else {state = 0; break;}
				case 36:
					if (ch == 'd') {AddCh(); state = 37; break;}
					else {state = 0; break;}
				case 37:
					{t.kind = 9; break loop;}
				case 38:
					if (ch == 'e') {AddCh(); state = 39; break;}
					else {state = 0; break;}
				case 39:
					if (ch == 'v') {AddCh(); state = 40; break;}
					else {state = 0; break;}
				case 40:
					if (ch == 'e') {AddCh(); state = 41; break;}
					else {state = 0; break;}
				case 41:
					if (ch == 'l') {AddCh(); state = 42; break;}
					else {state = 0; break;}
				case 42:
					if (ch == 'o') {AddCh(); state = 43; break;}
					else {state = 0; break;}
				case 43:
					if (ch == 'p') {AddCh(); state = 44; break;}
					else {state = 0; break;}
				case 44:
					if (ch == 'e') {AddCh(); state = 45; break;}
					else {state = 0; break;}
				case 45:
					if (ch == 'r') {AddCh(); state = 46; break;}
					else {state = 0; break;}
				case 46:
					if (ch == 's') {AddCh(); state = 47; break;}
					else {state = 0; break;}
				case 47:
					{t.kind = 10; break loop;}
				case 48:
					if (ch == 'o') {AddCh(); state = 49; break;}
					else {state = 0; break;}
				case 49:
					if (ch == 'o') {AddCh(); state = 50; break;}
					else {state = 0; break;}
				case 50:
					if (ch == 'k') {AddCh(); state = 51; break;}
					else {state = 0; break;}
				case 51:
					if (ch == 'i') {AddCh(); state = 52; break;}
					else {state = 0; break;}
				case 52:
					if (ch == 'n') {AddCh(); state = 53; break;}
					else {state = 0; break;}
				case 53:
					if (ch == 'g') {AddCh(); state = 54; break;}
					else {state = 0; break;}
				case 54:
