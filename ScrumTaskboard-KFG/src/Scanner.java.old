...
public class Scanner {
	...
	static {
		...
		for (int i = 51; i <= 57; ++i) start.set(i, 17);
		for (int i = 48; i <= 50; ++i) start.set(i, 18);
		start.set(34, 2); 
		start.set(69, 23); 
		start.set(84, 53); 
		start.set(68, 34); 
		...
		literals.put("of", new Integer(8));
		literals.put("open", new Integer(13));
		literals.put("active", new Integer(14));
		literals.put("done", new Integer(15));
		...
		loop: for (;;) {
			switch (state) {
				...
				case 1:
					...
					if (ch >= 'a' && ch <= 'z') {AddCh(); state = 1; break;}
					else {t.kind = 1; t.val = new String(tval, 0, tlen); CheckLiteral(); return t;}
				case 2:
					if (ch <= '!' || ch >= '#' && ch <= 65535) {AddCh(); state = 2; break;}
				...
				case 9:
					{t.kind = 3; break loop;}
				case 10:
					if (ch >= '0' && ch <= '5') {AddCh(); state = 11; break;}
					else {state = 0; break;}
				case 11:
				...
				case 14:
					if (ch >= '0' && ch <= '9') {AddCh(); state = 15; break;}
					else {state = 0; break;}
				case 15:
					{t.kind = 5; break loop;}
				case 16:
				...
				case 18:
					recEnd = pos; recKind = 5;
					if (ch >= '0' && ch <= '9') {AddCh(); state = 20; break;}
					else if (ch == '.') {AddCh(); state = 14; break;}
					else {t.kind = 5; break loop;}
				case 19:
					recEnd = pos; recKind = 5;
					if (ch >= '0' && ch <= '9') {AddCh(); state = 21; break;}
					else if (ch >= 'a' && ch <= 'z') {AddCh(); state = 16; break;}
					else if (ch == '.') {AddCh(); state = 14; break;}
					else {t.kind = 5; break loop;}
				case 20:
					recEnd = pos; recKind = 5;
				...
				case 23:
					if (ch == 'x') {AddCh(); state = 24; break;}
					else {state = 0; break;}
				case 24:
					if (ch == 'p') {AddCh(); state = 25; break;}
					else {state = 0; break;}
				case 25:
					if (ch == 'o') {AddCh(); state = 26; break;}
					else {state = 0; break;}
				case 26:
					if (ch == 'r') {AddCh(); state = 27; break;}
					else {state = 0; break;}
				case 27:
				...
				case 28:
					{t.kind = 7; break loop;}
				case 29:
					if (ch == 'o') {AddCh(); state = 30; break;}
					else {state = 0; break;}
				case 30:
					if (ch == 'a') {AddCh(); state = 31; break;}
					else {state = 0; break;}
				case 31:
					if (ch == 'r') {AddCh(); state = 32; break;}
					else {state = 0; break;}
				case 32:
					if (ch == 'd') {AddCh(); state = 33; break;}
					else {state = 0; break;}
				case 33:
					{t.kind = 9; break loop;}
				case 34:
					if (ch == 'e') {AddCh(); state = 35; break;}
					else {state = 0; break;}
				case 35:
					if (ch == 'v') {AddCh(); state = 36; break;}
					else {state = 0; break;}
				case 36:
					if (ch == 'e') {AddCh(); state = 37; break;}
					else {state = 0; break;}
				case 37:
					if (ch == 'l') {AddCh(); state = 38; break;}
					else {state = 0; break;}
				case 38:
					if (ch == 'o') {AddCh(); state = 39; break;}
					else {state = 0; break;}
				case 39:
					if (ch == 'p') {AddCh(); state = 40; break;}
					else {state = 0; break;}
				case 40:
				...
				case 45:
					if (ch == 'o') {AddCh(); state = 46; break;}
					else {state = 0; break;}
				case 46:
					if (ch == 'o') {AddCh(); state = 47; break;}
					else {state = 0; break;}
				case 47:
					if (ch == 'k') {AddCh(); state = 48; break;}
					else {state = 0; break;}
				case 48:
					if (ch == 'i') {AddCh(); state = 49; break;}
					else {state = 0; break;}
				case 49:
					if (ch == 'n') {AddCh(); state = 50; break;}
					else {state = 0; break;}
				case 50:
					if (ch == 'g') {AddCh(); state = 51; break;}
					else {state = 0; break;}
				case 51:
					if (ch == 's') {AddCh(); state = 52; break;}
					else {state = 0; break;}
				case 52:
					{t.kind = 12; break loop;}
				case 53:
					if (ch == 'a') {AddCh(); state = 54; break;}
					else {state = 0; break;}
				case 54:
					if (ch == 's') {AddCh(); state = 55; break;}
					else {state = 0; break;}
				case 55:
					if (ch == 'k') {AddCh(); state = 56; break;}
					else {state = 0; break;}
				case 56:
					if (ch == 'b') {AddCh(); state = 29; break;}
					else if (ch == 's') {AddCh(); state = 44; break;}
					else {state = 0; break;}
